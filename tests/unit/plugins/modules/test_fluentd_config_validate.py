...
MODULE_PATH = "ansible_collections.stevefulme1.fluentd.plugins.modules.fluentd_config_validate"
...
class TestFluentdConfigValidate:
    def test_valid_config(self, mock_find, mock_ansible):
        ...
        from ansible_collections.stevefulme1.fluentd.plugins.modules.fluentd_config_validate import main
    ...
    def test_invalid_config(self, mock_find, mock_ansible):
        ...
        module.run_command.return_value = (1, "", "config error on line 5\ninvalid directive")
        mock_ansible.return_value = module
