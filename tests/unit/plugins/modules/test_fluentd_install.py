"""Unit tests for fluentd_install module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.fluentd.plugins.modules.fluentd_install"


@patch(f"{MODULE_PATH}.AnsibleModule")
@patch(f"{MODULE_PATH}.get_os_family", return_value="RedHat")
class TestFluentdInstall:
    ...
    def test_check_mode(self, mock_os, mock_ansible):
        module = self._make_module(mock_ansible)
